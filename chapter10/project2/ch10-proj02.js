...
document.addEventListener("DOMContentLoaded", () => {
  ...
  */
  ...
  function firstDisplayAfterFetch(playData) {
    ...
    h3.textContent = playData.acts[0].name;
    article.appendChild(h3);
    
    const div1 = document.createElement('div');
    div1.setAttribute('id', 'sceneHere');
    
    const currentScenes = playData.acts[0].scenes[0];
    
    const h4 = document.createElement('h4');
    h4.textContent = currentScenes.name;
    div1.appendChild(h4);
    
    const p1 = document.createElement('p');
    p1.setAttribute('class', 'title');
    p1.textContent = currentScenes.title;
    div1.appendChild(p1);
    
    const p2 = document.createElement('p');
    p2.setAttribute('class', 'direction');
    p2.textContent = currentScenes.stageDirection;
    div1.appendChild(p2);
    
    speechesFromScene1OfAct1(currentScenes, div1);
